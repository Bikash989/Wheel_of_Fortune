...
class WOFHumanPlayer(WOFPlayer):
    ...
    def getMove(self,category, obscuredPhrase, guessed):
        ...
        print()
        print("Guess a letter, phrase, or type 'exit' or 'pass': ",end="")
        usr_input = input()
        return usr_input
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def smartCoinFlip(self):
        ...
        return True if rand > self.difficulty else False
    def getPossibleLetters(self,guessed):
        ...
        return l
    def getMove(self,category,obscuredPhrase,guessed):
        moves = self.getPossibleLetters(guessed)
        if(len(moves) == 0):
            pass
        else:
            # decide to make good or bad movie
            if(self.smartCoinFlip()):
                return collections.Counter(SORTED_FREQUENCIES).most_common(2)[0]
                
            else:
                rand_letter = random.choice(moves)
                return rand_letter
